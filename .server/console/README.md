...
**`success(char const*/std::string s)`**  
Displays a success message.

**`issue(char const*/std::string i)`**  
Displays an error/issue message.

**`info(char const*/std::string i)`**  
Displays an informational message.

**`warning(char const*/std::string w)`**  
Displays a warning message.

**`log(char const*/std::string l)`**  
Displays a plain log message.

**`GET(char const*/std::string path, int status, double in)`**  
Logs an HTTP GET request with the path, status code, and response time.

**`POST(char const*/std::string path, int status, double in)`**  
Logs an HTTP POST request with the path, status code, and response time.

**`DELETE(char const*/std::string path, int status, double in)`**  
